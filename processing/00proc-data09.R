...
issp09$ISCO88_or <- issp09$ISCO88
...
# 3.11 CLASS ESCHEME EGP ----

frq(issp09$V64)
frq(issp09$NEMPLOY)

issp09 <- issp09 %>% 
  mutate(selfemp_egp = if_else(V64 == 4, 1, 0),
         nemploy_egp = car::recode(NEMPLOY, recodes = c("9995 = 0; c(9997,9998,9999) = NA")))
