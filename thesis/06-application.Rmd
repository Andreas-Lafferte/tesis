...
```{r model, message=FALSE, warning=FALSE, include=FALSE, results='asis'}
...
```{r tab-model, echo=FALSE, results='asis'}
htmlreg(l = list(model_0, model_2, model_3, model_4, model_5),dcolumn = TRUE , type = "html", doctype = FALSE, digits = 2)
```
