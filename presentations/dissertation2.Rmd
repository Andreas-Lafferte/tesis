...
El conflicto como una relación de oposición en los objetivos/intereses/deseos de partes interdependientes, en la que a medida que aumentan las probabilidades de consecución de los objetivos de uno, disminuyen las de otro (Oberschall, 1978).
...
Las PCS son situaciones de oposición psicológica, es decir, se basan en un antagonismo de intereses (Fink, 1968; Pondy, 1967)
...
- Edlund & Lindh (2015) sostienen que las diferencias de clase sobre las preferencias redistributivas son sustancialmente más débiles en países muy desiguales en comparación con los países con mayor igualdad. ¿Ocurrirá el patrón inverso para las PCS?
...
- $H_{1}$ Individuos de clase trabajadora tenderán a percibir mayores conflictos, en cambio individuos de clase alta tenderán a percibir menores conflictos.  

## Hipótesis comparación

### _Sobre clase social_
- $H_{2}$ Individuos de clase trabajadora tenderán a percibir mayor conflicto, en cambio individuos de clase alta tenderán a percibir menor conflicto.  

---
# 5.1. Hipótesis principales

## Hipótesis comparación
### _Sobre desigualdad económica_
- $H_{3a}$ Mayores niveles de desigualdad económica aumentarán las percepciones de conflicto social 

- $H_{3b}$ Mayores niveles de desigualdad económica implicará que los individuos de clase trabajadora perciban mayores conflictos e individuos de clase alta percibirán menores conflictos. Es decir, las diferencias de clase se acrecentarán. 
---
# 5.1. Hipótesis principales

## Hipótesis comparación

### _Sobre coordinación salarial_
- $H_{4a}$ La baja coordinación salarial (LME's) de un país producirá que individuos de clase trabajadora percibirán mayor conflicto que individuos de clase alta. 

- $H_{4b}$ En países con baja coordinación salarial (LME's) y altos niveles de desigualdad económica las percepciones de conflicto social serán mayores que en países con alta coordinación salarial (CME's). 
...
| Brecha salarial justa | Brecha entre salarios justos de ocupaciones extremas | ISSP | 
...
| Sociodemográficas | Ingreso/Nivel educativo/Sexo | ISSP | 
...
|------------:|-----------:|------------:|
| *Nivel 2*   |            |             |
| Desigualdad ecónomica | Índice de GINI | OCDE-SWIID |
...
## Enfoque comparado
¿Observaciones sobre las decisiones metodólogicas? ¿Se plantean correctamente ambos objetivos?
